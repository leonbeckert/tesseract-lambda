...
wget https://github.com/tesseract-ocr/$TESSDATA_VERSION/raw/main/eng.traineddata
# add more as needed
# wget https://github.com/tesseract-ocr/$TESSDATA_VERSION/raw/main/deu.traineddata


cd ~
# trim unneeded ~ 15 MB
strip ./tesseract-standalone/lib/*
strip ./tesseract-standalone/bin/*


cd tesseract-standalone


zip -r9 /tmp/build/tesseract.zip *
